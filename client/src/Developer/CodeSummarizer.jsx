...
export default function CodeSummarizer() {
  ...
  const handleCodeAnalysis = async () => {
    try {
      ...
      const response = await getResponseGemini({prompt: `${codeInput} Analyse the above code and give me summary of that code in one paragraph, don't think about syntax.. just give summary of the logic`});
