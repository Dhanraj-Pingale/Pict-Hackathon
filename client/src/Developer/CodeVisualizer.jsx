...
const CodeVisualizer = () => {
  ...
  return (
    <>
      {/* <Navbar /> */}
      <div className={`${darkMode ? 'bg-customDark text-white' : 'bg-gray-100 text-customDark'} h-screen`}>
        ...
        <Split className="split flex" minSize={200} gutterSize={10}>
          {/* Editor Panel */}
          <div className={`w-1/2 p-4 rounded-xl ml-3 ${darkMode ? 'bg-customDarker' : 'bg-gray-200'}`}>
