...
const DialogBox = ({ showDialog, setShowDialog, activeTab, setActiveTab, addText, addHeading2, addHeading1, addLink, addVideo, addCodeSnippet }) => {
      ...
      <ul className="space-y-3">
        ...
        {activeTab === 'Basic' && (
          <>
            ...
            <li className="flex items-center space-x-3 cursor-pointer hover:bg-gray-700 p-2 rounded" onClick={addHeading1}>
              <FaHeading className="text-gray-400" />
              <span>Add Heading 1</span>
            </li>
            <li className="flex items-center space-x-3 cursor-pointer hover:bg-gray-700 p-2 rounded" onClick={addHeading2}>
              <FaHeading className="text-gray-400" />
            ...
            <li className="flex items-center space-x-3 cursor-pointer hover:bg-gray-700 p-2 rounded" onClick={addLink}>
